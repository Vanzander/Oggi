...
# oggimexico.pinterest-verification
...
3. You'll see a warning message about needing to enter the necessary configurations. Scroll down and type in your **content** in the `pinterest-verification` field.
4. Click on **Save**.
...
3. Fill in the `pinterest-verification` field with your **content**.
4. Click on **Save**.
