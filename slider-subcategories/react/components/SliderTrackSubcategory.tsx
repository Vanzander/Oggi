...
import { useSliderState, useSliderDispatch } from './SliderContextSubcategory'
import { useSliderGroupDispatch } from '../SliderSubcategoriesGroup'
import { useSliderVisibility } from '../hooks/useSliderVisibilitySubcategory'
...
const SliderTrackSubcategory: FC<Props> = ({
  infinite,
  usePagination,
  centerMode,
  totalItems,
...
export default SliderTrackSubcategory
