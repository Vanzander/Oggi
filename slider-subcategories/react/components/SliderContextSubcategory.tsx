import React, {
  ...
  import { useSliderGroupState } from '../SliderSubcategoriesGroup'
  ...
  interface State extends Partial<SliderSubcategoriesProps> {
    /** Width of each slide */
    slideWidth: number
    ...
    slideTransition: Exclude<SliderSubcategoriesProps['slideTransition'], undefined>
  }
  
  interface SliderContextProps extends SliderSubcategoriesProps {
    totalItems: number
    infinite: SliderSubcategoriesSiteEditorProps['infinite']
  }
