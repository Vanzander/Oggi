...
import PaginationDots from '../components/PaginationDotsSubcategory'

const mockGoForward = jest.fn()
const mockGoBack = jest.fn()

jest.mock('../components/SliderContextSubcategory', () => {
  return {
    useSliderState: () => ({
      slideWidth: 20,
      slidesPerPage: 5,
...
jest.mock('../hooks/useSliderControlsSubcategory', () => {
  return {
    useSliderControls: () => ({
